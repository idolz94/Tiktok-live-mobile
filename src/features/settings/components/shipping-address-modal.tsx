...
import {
  AddressForm,
  GeoPickerState,
} from "@features/settings/schemas/shipping-address-form-schema";
...
import {
  ...
  PickerField,
  SwitchRow,
} from "./shipping-address-form-fields";
...
export function ShippingAddressModal({
  ...
  return (
    <View
      style={[styles.modalCard, variant === "page" && styles.modalPageCard]}
    >
      <View style={styles.modalHeader}>
        <Text style={styles.modalTitle}>
          {editingAddress ? "Sửa địa chỉ kho" : "Thêm địa chỉ kho"}
        </Text>
      ...
      >
        ...
        <Pressable
          style={[
            styles.saveButton,
            (isSavingAddress || !isValid) && styles.saveButtonDisabled,
          ]}
          onPress={onSave}
